...
SRCS = src/main.c src/map_checker.c src/so_long.c src/key_events.c src/move_player.c src/mov_count_on_screen.c src/free.c src/check_xpm.c src/map_checker_2.c src/print.c
